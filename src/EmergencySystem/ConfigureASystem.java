...
//Emerson College
        ...
        Enterprise enterprisen2_2 = n1.getEntDirObj().createAndAddEnterprise("NEUPSAP",type1_n2,"360 Huntington Ave, Boston, MA 02115" );
        
        Enterprise.EnterpriseType type2_n2 = EnterpriseType.POLICEENTERPRISE;
        Enterprise enterprisen2_3 = n1.getEntDirObj().createAndAddEnterprise("NEUPolice",type2_n2,"" );
        
//        Enterprise.EnterpriseType type3_n21 = EnterpriseType.FIREDEPARTMENTENTERPRISE;
//        Enterprise enterprisen2_41 = n1.getEntDirObj().createAndAddEnterprise("northeast fire and rescue",type3_n21,"1400 3rd St, Enola, PA 17025" );
       //Creation of boston enterprise admin
        ...
        enterprisen2_2.getUserAccountDirectory().createUserAccount("NEUPSAPadmin", "NEUPSAPadmin", bostonpsapAdmin, new Emergency911EnterpriseAdminRole());
        ...
        enterprisen2_3.getUserAccountDirectory().createUserAccount("NEUPoliceadmin", "NEUPoliceadmin", bostonPoliceAdmin, new PoliceAdminRole());
        bostonPoliceAdmin.setAvailable(true);
        
        
        //creating firestations in the network
        FireStation f1 = n1.addFireStation("Boston Fire Department Engine Company 37");
        f1.setFireStation("Boston Fire Department - Engine Company 37");
        f1.setFireStationLocation("560 Huntington Ave, Boston, MA 02115");
        
         FireStation f2 = n1.addFireStation("Boston Fire Department Engine 42");
        f2.setFireStation("Boston Fire Department Engine 42");
        f2.setFireStationLocation("870 Columbus Ave, Boston, MA 02119");
           
        
        EnterpriseAdmin f1n1= new EnterpriseAdmin();
        f1n1.setName("bfd37");
        f1.getEmployeeDirectory().createEmployee(f1n1);
        f1.getUserAccountDirectory().createUserAccount("bfd37","bfd37",f1n1,new FireDepartmentAdminRole());
        
             
        EnterpriseAdmin f2n1= new EnterpriseAdmin();
        f2n1.setName("bfd42");
        f2.getEmployeeDirectory().createEmployee(f2n1);
        f2.getUserAccountDirectory().createUserAccount("bfd42","bfd42",f2n1,new FireDepartmentAdminRole());
        
        f1.getOrganizationDirectory().createOrganisation(Type.FIREENGINE);
        f2.getOrganizationDirectory().createOrganisation(Type.FIREENGINE);
        
         FireEngine fe1_n1=new FireEngine();
        fe1_n1.setName("engine1");
        fe1_n1.setAvailability("Available");
        
        FireEngine fe2_n1=new FireEngine();
        fe2_n1.setName("engine2");
        fe2_n1.setAvailability("Available");
        
         FireEngine fe3_n1=new FireEngine();
        fe1_n1.setName("engine1");
        fe1_n1.setAvailability("Available");
        
        FireEngine fe4_n1=new FireEngine();
        fe2_n1.setName("engine2");
        fe2_n1.setAvailability("Available");
        
        
    
       for(Organisation org: f1.getOrganizationDirectory().getOrganisationList())
       {
           if(org instanceof FireEngineOrganization)
           {
               ((FireEngineOrganization)org).getEmployeeDirectory().createEmployee(fe1_n1);
         ...
         for(Organisation org: f2.getOrganizationDirectory().getOrganisationList())
       {
           if(org instanceof FireEngineOrganization)
           {
               ((FireEngineOrganization)org).getEmployeeDirectory().createEmployee(fe3_n1);
        ...
        //        EnterpriseAdmin bostonFireDeptAdmin= new EnterpriseAdmin();
//        enterprisen2_41.getEmployeeDirectory().createEmployee(bostonFireDeptAdmin);
//        enterprisen2_41.getUserAccountDirectory().createUserAccount("bosfiredepadmin", "bosfiredepadmin", bostonFireDeptAdmin, new FireDepartmentAdminRole());
...
////        h1_2.setHospitalLocation("75 Francis St, Boston, MA 02115");
         ...
         for(Organisation org: h1_4.getOrganizationDirectory().getOrganisationList())
       {
        ...
        n2.setNetworkName("Boston University");
        
        //Creating enterprises in cambridge network

        Enterprise.EnterpriseType type3_n2 = EnterpriseType.EMEREGENCY911ENTERPRISE;
        Enterprise enterprise_n2_2 = n2.getEntDirObj().createAndAddEnterprise("BUPSAP",type3_n2,"1350 Washington park. Boston, MA 02138" );
      
        Enterprise.EnterpriseType type4_n2 = EnterpriseType.POLICEENTERPRISE;
        Enterprise enterprisen2_4 = n2.getEntDirObj().createAndAddEnterprise("BUPolice",type4_n2,"" );
        
//        Enterprise.EnterpriseType type3_n22 = EnterpriseType.FIREDEPARTMENTENTERPRISE;
//        Enterprise enterprisen2_42 = n1.getEntDirObj().createAndAddEnterprise("Boston f&r",type3_n22,"1400 Rochester Av, Boston, MA 02138" );
//       
        ...
        enterprise_n2_2.getUserAccountDirectory().createUserAccount("BUPSAPadmin", "BUPSAPadmin", cambridgepsapAdmin, new Emergency911EnterpriseAdminRole());
        ...
        enterprisen2_4.getUserAccountDirectory().createUserAccount("BUPoliceadmin", "BUPoliceadmin", cambridgePoliceAdmin, new PoliceAdminRole());
        cambridgePoliceAdmin.setAvailable(true);
        
//          EnterpriseAdmin NEUFireDeptAdmin= new EnterpriseAdmin();
//        enterprisen2_42.getEmployeeDirectory().createEmployee(NEUFireDeptAdmin);
//        enterprisen2_42.getUserAccountDirectory().createUserAccount("NEUfiredepadmin", "NEUfiredepadmin", bostonFireDeptAdmin, new FireDepartmentAdminRole());

//creating Fire Stations

 FireStation f3 = n2.addFireStation("Brookline Fire Department Station #5");
        f3.setFireStation("Brookline Fire Department Station #5");
        f3.setFireStationLocation("49 Babcock St, Brookline, MA 02446");
        
         FireStation f4 = n2.addFireStation("Brookline Fire Department Station #7");
        f4.setFireStation("Brookline Fire Department Station #7");
        f4.setFireStationLocation("665 Washington St, Brookline, MA 02446");
        
        
        EnterpriseAdmin f3n2= new EnterpriseAdmin();
        f3n2.setName("bfd5");
        f3.getEmployeeDirectory().createEmployee(f3n2);
        f3.getUserAccountDirectory().createUserAccount("bfd5","bfd5",f3n2,new FireDepartmentAdminRole());
        
             
        EnterpriseAdmin f4n2= new EnterpriseAdmin();
        f4n2.setName("bfd7");
        f4.getEmployeeDirectory().createEmployee(f4n2);
        f4.getUserAccountDirectory().createUserAccount("bfd7","bfd7",f4n2,new FireDepartmentAdminRole());

            f3.getOrganizationDirectory().createOrganisation(Type.FIREENGINE);
        f4.getOrganizationDirectory().createOrganisation(Type.FIREENGINE);
        
         FireEngine fe1_n2=new FireEngine();
        fe1_n2.setName("engine1");
        fe1_n2.setAvailability("Available");
        
        FireEngine fe2_n2=new FireEngine();
        fe2_n2.setName("engine2");
        fe2_n2.setAvailability("Available");
        
         FireEngine fe3_n2=new FireEngine();
        fe3_n2.setName("engine1");
        fe3_n2.setAvailability("Available");
        
        FireEngine fe4_n2=new FireEngine();
        fe4_n2.setName("engine2");
        fe4_n2.setAvailability("Available");
        
        
    
       for(Organisation org: f3.getOrganizationDirectory().getOrganisationList())
       {
           if(org instanceof FireEngineOrganization)
           {
               ((FireEngineOrganization)org).getEmployeeDirectory().createEmployee(fe1_n2);
              ...
              for(Organisation org: f4.getOrganizationDirectory().getOrganisationList())
       {
           if(org instanceof FireEngineOrganization)
           {
               ((FireEngineOrganization)org).getEmployeeDirectory().createEmployee(fe3_n2);
