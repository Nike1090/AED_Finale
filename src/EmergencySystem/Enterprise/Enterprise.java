...
public abstract class Enterprise extends Organisation{
    ...
    public enum EnterpriseType{
       HOSPITALENTERPRISE("Hospital Enterprise"),POLICEENTERPRISE("Police Enterprise"),EMEREGENCY911ENTERPRISE("Emergency 911 Enterprise"),FIRESTATIONENTERPRISE("Department of Fire Services");
